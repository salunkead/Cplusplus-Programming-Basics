// Inheritance in c++ :-> publically inheriting members of the parent class
#include <iostream>
using namespace std;
class parent
{
...
3.visibility modes are public or private or protected.the default visibility mode is private
